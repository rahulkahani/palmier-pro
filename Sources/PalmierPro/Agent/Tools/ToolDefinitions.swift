                    ...
                    "entries": [
                        ...
                        "items": [
                            ...
                            "properties": [
                                ...
                                "trimEndFrame": ["type": "integer", "description": "Optional. Frames trimmed off the END of the source media, in PROJECT frames — same units as trimStartFrame. Omit (recommended) to keep all remaining source past the clip as headroom so the clip stays extendable; set a value only to explicitly trim the tail."],
                            ],
                    ...
                    "entries": [
                        ...
                        "items": [
                            ...
                            "properties": [
                                ...
                                "trimEndFrame": ["type": "integer", "description": "Optional. Frames trimmed off the END of the source media, in PROJECT frames. Omit (recommended) to keep all remaining source as headroom so the clip stays extendable; set a value only to explicitly trim the tail."],
                            ],
                            "required": ["mediaRef"],
                        ],
                    ],
